...
#               for Windows 11 24H2 and also install drivers and Windows updates to latest as needed.
#================================================================================================
...
Write-Host "Downloading Latest Cumulative Update for Windows 11 24H2 - 02 Fevereiro, 2025"
curl.exe -L -o "C:\MSupdates\LCU\Windows11-24H2-LCU.msu" "C:\MSupdates\LCU\Windows11-24H2-LCU.msu" "https://catalog.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/d8b7f92b-bd35-4b4c-96e5-46ce984b31e0/public/windows11.0-kb5043080-x64_953449672073f8fb99badb4cc6d5d7849b9c83e8.msu"
